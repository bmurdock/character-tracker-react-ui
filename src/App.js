...
import {LoggedInContext, LoggedInUserContext, AppNameContext, ClassesContext, RacesContext, MergedContext} from './Context';
...
class App extends Component {
  ...
  render() {
    return (
      <Router>
          <Switch>
            <MergedContext.Provider value={{classes: this.state.classes, races: this.state.races }}>
